...
//#define  MAX_N_TASKS 500 JPG.20200430 not used
...
//JPG.20200430 originally, the n_stations and LB were char variables. For n=1000 this is not a feasible strategy. The code has modified accordingly and every value is now an integer 
//(could be unsigned short or similar)
typedef struct state
{
  char  *degrees;      // The number of immediate predecessor not yet assigned to a workstation
  int  n_stations;    // The total number of work stations that have been used so far
